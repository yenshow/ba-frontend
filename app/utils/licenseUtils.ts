...
export const getFeatureKeyByRoute = (routePath: string): FeatureKey | null => {
	...
	if (routePath.startsWith("/infrastructure/hvac")) return "hvac"
	if (routePath.startsWith("/infrastructure/drainage")) return "drainage"
	if (routePath.startsWith("/infrastructure/power")) return "power"
	if (routePath.startsWith("/security/fire")) return "fire"
	if (routePath.startsWith("/infrastructure/fire")) return "fire"
	if (routePath.startsWith("/security/emergency")) return "emergency_rescue"
