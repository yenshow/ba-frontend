/** 與後端 permissionCatalog SHARED_MODULES 對齊（Construction 部署） */
...
export const PERM = {
	...
	peopleCounting: {
		...
		reportExport: "system.people_counting.report.export"
	},
	environment: {
		...
		reportExport: "system.environment.report.export"
	},
	vehicleAccess: {
		...
		reportExport: "system.vehicle_access.report.export",
