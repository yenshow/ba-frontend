...
export const PERM = {
	...
	areaPointMap: {
		...
		zoneCreate: "system.area_point_map.zone.create",
		zoneUpdate: "system.area_point_map.zone.update",
		zoneDelete: "system.area_point_map.zone.delete",
		locationDelete: "system.area_point_map.location.delete",
	},
	lighting: { module: "system.lighting" },
	hvac: { module: "system.hvac" },
	power: { module: "system.power" },
	drainage: { module: "system.drainage" },
	airCirculation: { module: "system.air_circulation" },
	fire: { module: "system.fire" },
	emergencyRescue: { module: "system.emergency_rescue" },
	smokeAlarm: { module: "system.smoke_alarm" },
	multimedia: { module: "system.multimedia" },
} as const
