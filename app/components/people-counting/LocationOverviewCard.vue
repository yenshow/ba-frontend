<template>
	<div
		class="flex cursor-pointer gap-2 rounded-xl py-1 bg-white/10 transition-all"
	...
	>
		...
		<div class="flex flex-1 flex-col items-center pr-2">
			...
			<div class="flex items-center gap-8 py-2">
				<!-- 三種人數統計 -->
				<div
					class="flex min-w-[140px] flex-col gap-3 2xl:min-w-[160px] text-white border-r-2 border-white/50 pr-8"
				>
