...
const asLighting = (loc: AirCirculationLocation): LightingLocation => loc as unknown as LightingLocation

const localLocation = ref<AirCirculationLocation>({ ...props.location })
const deviceIdString = ref("")

const ensureModbusConfig = (location: AirCirculationLocation) => {
