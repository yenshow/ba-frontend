...
interface Emits {
	...
	(e: "update-location", index: number, location: SmokeAlarmLocation): void
...
const getLocations = (zone: SmokeAlarmZone): SmokeAlarmLocation[] => {
	return zone.locations || []
}

const getLocationId = (location: SmokeAlarmLocation, index: number): string => {
...
const handleLocationUpdate = (locationIndex: number, updatedLocation: SmokeAlarmLocation) => {
