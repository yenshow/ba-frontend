...
const getLocations = (z: DrainageZone): DrainageLocation[] => {
	return z.locations || [];
};

const getLocationId = (location: DrainageLocation, index: number): string => {
	return (location as { id?: string }).id || `location-${index}`;
};
