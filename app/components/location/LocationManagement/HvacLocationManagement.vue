...
const getLocations = (zone: HvacZone): HvacLocation[] => zone.locations || []

const getLocationId = (location: HvacLocation, index: number): string =>
...
const handleLocationUpdate = (locationIndex: number, updatedLocation: HvacLocation) => {
